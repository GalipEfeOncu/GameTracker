...
- **Arayüz dili:** Türkçe (varsayılan) veya English — `PreferencesContext` + `frontend/src/i18n/tr.json` / `en.json` (`locale` `gt_preferences` ile saklanır).
...
- **i18n** — TR/EN uygulama metinleri; oyun adı ve API hata metinleri sunucu dilinde kalabilir.
